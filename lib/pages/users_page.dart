...
import 'package:lets_chat/providers/users_page_provider.dart';
...
class _UsersPageState extends State<UsersPage> {
  ...
  Widget _createChatButton() {
    return Visibility(
      ...
      child: RoundedButton(name: _pageProvider.selectedUsers.length == 1
          ? "Chat With ${_pageProvider.selectedUsers.first.name} ": "Create Group Chat",
